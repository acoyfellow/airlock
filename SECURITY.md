...
airlock is an orchestration primitive. it does not deploy, hold secrets, or
...
- airlock makes no trust decision itself; it delegates admission to keel and
...
- a compromised owner root, or a verifier key trusted and active at signing
  time, can sign a proof for a bad candidate. airlock narrows where authority is
